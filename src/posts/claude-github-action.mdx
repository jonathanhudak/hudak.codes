...
image: /posts/images/claude-flow-whiteboard.jpg
---
...
![Claude GitHub Action workflow: Developer → Issue → GitHub Action → Claude AI → Pull Request → Review](/posts/images/claude-flow-whiteboard.jpg)
